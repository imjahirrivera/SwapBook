...
function validarFormulario() {
    ...
    var codigo_academicos = document.getElementById("codigo_estudiante").value.trim();
    ...
    if (codigo_academicos === "") {
        errores += "❌El código de estudiante es obligatorio.<br>";
    } else if (!/^\d{9}$/.test(codigo_academicos)) {
...
function validarFormularioAdmin() {
    ...
    var correo = document.getElementById("correo_electronico").value.trim();
    var telefono = document.getElementById("numero_telefono").value.trim();
    var codigo_academicos = document.getElementById("codigo_academicos").value.trim();
    var contrasena = document.getElementById("password").value.trim();
    var contrasena2 = document.getElementById("password2").value.trim();
    ...
    if (correo === "") {
        errores += "❌El correo electrónico es obligatorio.<br>";
    } else if (!correo.endsWith("@academicos.udg.mx")) {
        errores += "❌El correo electrónico debe terminar con @academicos.udg.mx<br>";
    }
    ...
    if (razon === "") { 
        errores += "❌La razón de ser administrador es obligatoria.<br>"; 
    }
