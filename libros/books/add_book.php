...
<head>
    ...
    <title>SwapBook: Agregar libro</title>
</head>
<body>
...
<div id="body" class="p-10 bg-local bg-cover bg-no-repeat" style="background-image: url(../img/library.jpg);">
    ...
    <div class="mx-auto w-full max-w-screen-xl p-20 py-6 lg:py-8 bg-black/90 rounded-3xl flex flex-col">
        ...
        <div class="md:flex md:justify-between items-center">
            <span class="text-6xl font-semibold whitespace-nowrap dark:text-white">Agregar Libro</span>
        </div>
        ...
        <div class="flex pt-10 pb-10 justify-center">
            ...
            <div class="flex w-full items-center justify-center">
                <form action="<?php echo 'cox_add_book.php?id=' . $_GET['id'] . '&url=' . $_GET['url'];?>" method="POST" class="flex w-full justify-center" id="formulario" enctype="multipart/form-data">
                    <div class="flex items-center justify-center flex-col w-1/3">
                        <label class="m-10 flex flex-col items-center justify-center w-full h-3/4 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                    ...
                    <div class="flex flex-col w-1/2 pl-12">
                        <div class="pb-3">
                            ...
                            <input type="text" id="titulo" name="titulo" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="Encabezado">
                        </div>
                        <div class="pb-3">
                            ...
                            <input type="text" id="autor" name="autor" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="Nombre completo">
                        </div>
                        <div class="pb-3">
                            ...
                            <input type="text" id="isbn" name="isbn" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="International Standard Book Number">
                        </div>
                        <div class="pb-3">
                            ...
                            <input type="text" id="editorial" name="editorial" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="Institucional">
                        </div>
                        <div class="pb-3">
                            ...
                            <input type="number" id="num_paginas" name="num_paginas" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="Cantidad">
                        </div>
                        <div class="pb-3">
                            ...
                            <input type="text" id="idioma" name="idioma" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="Español/Inglés">
                        </div>
                        <div class="pb-3">
                            ...
                            <input type="text" id="categoria" name="categoria" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="Categoria que mejor describa el libro.">
                        </div>
                        <div class="pb-3">
                            ...
                            <select id="estado_fisico" name="estado_fisico" class=" w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none">
                                ...
                                <option value="Nuevo">Nuevo (100%)</option>
                                <option value="Seminuevo">Seminuevo (75%)</option>
                                <option value="Usado">Usado (50%)</option>
                                <option value="Muy usado">Muy usado (25)</option>
                            </select>
                        </div>
                        <div class="pb-3">
                            ...
                            <textarea id="sinopsis" name="sinopsis" rows="4" class=" w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" style="resize: none;" placeholder="Descripción"></textarea>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="flex items-center p-12 items-center justify-center">
            <button type="submit" onclick="submitBook();" class="ml-4 pl-4 pr-4 relative flex w-fit h-12 rounded-full bg-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 items-center justify-center mt-auto" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
