    ...
    <div class="mx-auto w-full max-w-screen-xl p-20 py-6 lg:py-8 bg-black/90 rounded-3xl flex flex-col">
        ...
        <div class="flex my-12 justify-center">
            ...
            if(($user -> codigo_estudiante) == ($codigo_estudiante)){
                ...
                echo '<button type="button" onclick="listaDeEspera();" class="mr-4 relative flex w-fit h-12 rounded-full bg-white px-4 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 items-center justify-center mt-auto" id="user-menu-button" aria-expanded="false" aria-haspopup="true">';
...
<script>
    ...
    function listaDeEspera() {
        ...
        var id_libro = params.get('id_libro');
        // Tu código JavaScript aquí
        window.location.href = 'http://localhost/libros/books/cox_lista_espera.php?id=' + id + '&url=' + url + '&id_libro=' + id_libro;
    }
