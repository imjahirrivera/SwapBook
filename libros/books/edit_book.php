...
<div id="body" class="p-10 bg-local bg-cover bg-no-repeat" style="background-image: url(../img/library.jpg);">
    ...
    <div class="mx-auto w-full max-w-screen-xl p-20 py-6 lg:py-8 bg-black/90 rounded-3xl flex flex-col">
        ...
        <div class="flex pt-10 pb-10 justify-center">
            ...
            <div class="flex items-center justify-center w-80 flex-col">
                <label class="m-10 flex flex-col items-center justify-center w-full h-3/4 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click para agregar</span> o arrastra tu imagen</p>
            ...
            <div class="flex pl-12 pr-12 w-fit items-center justify-center">
                <form action="" class="flex flex-col w-96">
                    <label class="block mb-1 text-sm font-medium text-gray-500">Autor</label>
                    <input type="text" id="" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="Nombre y Apellido">
                    <label class="block mb-1 text-sm font-medium text-gray-500 pt-6">Título</label>
                    <input type="text" id="" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="Encabezado">
                    <label class="block mb-1 text-sm font-medium text-gray-500 pt-6">ISBN</label>
                    <input type="text" id="" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="International Standard Book Number">
                    <label class="block mb-1 text-sm font-medium text-gray-500 pt-6">Editorial</label>
                    <input type="text" id="" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="Institucional">
                    <label class="block mb-1 text-sm font-medium text-gray-500 pt-6">Número de páginas</label>
                    <input type="number" id="" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" placeholder="Cantidad">
                    
                    <label class="block mb-1 text-sm font-medium text-gray-500 pt-6">Estado físico del libro</label>
                    <select id="u" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none">
                        <option selected>Selecciona una opción</option>
                        <option value="US">Nuevo (100%)</option>
                        <option value="CA">Seminuevo (75%)</option>
                        <option value="FR">Usado (50%)</option>
                        <option value="DE">Muy usado (25)</option>
                    </select>
                    
                    <label class="block mb-1 text-sm font-medium text-gray-500 pt-6">Sinopsis</label>
                    <textarea id="message" rows="4" class="block w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" style="resize: none;" placeholder="Descripción"></textarea>
                </form>
            </div>
        </div>
        ...
        <div class="flex items-center p-12 items-center justify-center">
            <button type="button" class="ml-4 pl-4 pr-4 relative flex w-fit h-12 rounded-full bg-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 items-center justify-center mt-auto" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                <span class="text-xl font-semibold whitespace-nowrap dark:text-black">Guardar Libro</span>
            </button>
        </div>
