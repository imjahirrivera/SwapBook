...
$query = "UPDATE solicitud_prestamos SET status_solicitante = 'En curso', status_propietario = 'En prestamo' WHERE id = '$id_solicitud';";
...
$query3 = "UPDATE libro SET estatus = false WHERE id = '$id_libro';";
