                    ...
                    <?php
                        ...
                        while($solicitud = pg_fetch_object($result4)){
                            ...
                            if($status == "En curso"){
                                ...
                                echo            '<button onclick="abrirChat(' . $solicitud -> id . ')" class="w-12 h-12 rounded-full bg-white mr-2 hover:bg-gray-400 flex items-center justify-center" onclick="abrirChat('. $solicitud->id . ');">
                    ...
                    <?php
                        ...
                        while($solicitud = pg_fetch_object($result6)){
                            ...
                            if($status == "Entregado"){
                                ...
                                echo        '</div>';
                                echo        '<div class="flex items-center justify-center w-1/3">';
                                echo            '<button onclick="resena(' . $propietario -> id . ', ' . $libro -> id . ');" class="w-12 h-12 rounded-full bg-white mr-2 hover:bg-gray-400 flex items-center justify-center" onclick="reportar('. $solicitud->id . ');">
                                                    <svg class="w-6 h-6 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                        ...
                        while($solicitud = pg_fetch_object($result7)){
                            ...
                            if($status == "Entregado"){
                                ...
                                echo        '</div>';
                                echo        '<div class="flex items-center justify-center w-1/3">';
                                echo            '<button onclick="reporte(' . $solicitante -> id . ');" class="w-12 h-12 rounded-full bg-white mr-2 hover:bg-gray-400 flex items-center justify-center" onclick="reportar('. $solicitud->id . ');">
                                                    <svg class="w-6 h-6 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                                    <path d="M15 1.943v12.114a1 1 0 0 1-1.581.814L8 11V5l5.419-3.871A1 1 0 0 1 15 1.943ZM7 4H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2v5a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2V4ZM4 17v-5h1v5H4ZM16 5.183v5.634a2.984 2.984 0 0 0 0-5.634Z"/>
                                                    </svg>
                                                </button>';
...
<script>
    ...
    function abrirChat(id) {
        ...
        window.location.href = 'http://localhost/libros/user/chats.php?id_intercambio=' + id + '&id=' + id_user + '&url=' + url;
    }

    function resena(id_usuario, id_libro) {
        var queryString = window.location.search;
        ...
        window.location.href = 'http://localhost/libros/user/resena.php?id=' + id_user + '&url=' + url + '&id_usuario=' + id_usuario + '&id_libro=' + id_libro;
    }

    function reporte(id_usuario) {
        var queryString = window.location.search;
        ...
        window.location.href = 'http://localhost/libros/user/reporte.php?id=' + id_user + '&url=' + url + '&id_usuario=' + id_usuario;
    }
</script>
