    ...
    <div class="mx-auto w-full max-w-screen-xl p-20 py-6 lg:py-8 bg-black/90 rounded-3xl md:flex  md:flex-col">
        ...
        <div class="flex pt-10 pb-10">
            ...
            <div class="flex flex-col items-center">
                ...
                <button type="button" onclick="editarPerfil();" class="relative flex w-44 h-12 rounded-full bg-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 items-center justify-center mt-auto" id="user-menu-button">
        ...
        <!-- LINEA -->
        <hr class="mx-auto border-gray-400 mb-8 w-full"> </hr>
        ...
        <div class="flex flex-col">
                ...
                <?php
                    ...
                    while ($libro = pg_fetch_object($result2)) {
                        ...
                        if ($counter % 4 == 0) {
                            ...
                            echo '<div class="flex w-full mb-6">'; // Nuevo contenedor de fila
                        }
                        ...
                        echo '<div class="swiper-slide flex flex-col w-60 h-96 mr-12">';
            ...
            <div class="flex items-center justify-center p-12 w-full">
                ...
                <button type="button" onclick="moreBooks();" class="ml-4 pl-4 pr-4 relative flex w-fit h-12 rounded-full bg-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 items-center justify-center mt-auto" id="user-menu-button" >
                    <span class="text-xl font-semibold whitespace-nowrap dark:text-black">Ver Todos Los Libros</span>
                </button>
            </div>
        ...
        <div class="flex my-3 flex-col justify-center">
            ...
            <!-- RESENAS-->
                <?php 
                    ...
                    $query = "SELECT * FROM resenas WHERE id_usuario = $id_estudiante;";
                    $result = pg_query($conexion, $query);

                    $validacion = "SELECT COUNT(*) FROM resenas WHERE id_usuario = $id_estudiante;";
                    ...
                    if($count < 1){
                        ...
                        while($resena = pg_fetch_object($result)){
