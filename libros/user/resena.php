...
try{
 ...
 //Obtenemos el objeto del estudiante al que le vamos a hacer la resena
$id = $_GET['id_usuario'];
...
<div id="body" class="p-10 bg-local bg-cover bg-no-repeat" style="background-image: url(../img/library.jpg);">
    ...
    <div class="mx-auto w-full max-w-screen-xl p-20 py-6 lg:py-8 bg-black/90 rounded-3xl flex flex-col">
        ...
        <div class="md:flex md:justify-between items-center">
            <span class="text-4xl font-semibold whitespace-nowrap dark:text-white">Agrega un comentario sobre este usuario</span>
        </div>
        ...
        <div class="flex mt-5 mb-10 justify-center flex-col">
            ...
            <div class="flex w-full items-center justify-center">
                <form action="<?php echo 'cox_agregar_comentario.php?id=' . $_GET['id'] . '&url=' . $_GET['url'] . '&id_usuario=' . $_GET['id_usuario'] . '&id_libro=' . $_GET['id_libro'];?>" method="POST" class="flex flex-col items-center w-full justify-center" id="formulario" enctype="multipart/form-data">
                    <div class="flex flex-col w-1/2">
                        <div class="pb-6">
                            <label class=" mb-1 text-base font-medium text-gray-300 pt-6">Reseña</label> <label class=" mb-1 text-sm font-medium text-red-500 pt-6 pl-2" id="error_resena"> </label>
                            <textarea id="resena" name="resena" rows="4" class=" w-full h-48 p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none" style="resize: none;" placeholder="Descripción. Max. 200 caracteres."></textarea>
                        </div>
                        <div class="">
                            <label class=" mb-1 text-base font-medium text-gray-300 pt-6">Califica a este usuario</label> <label class=" mb-1 text-sm font-medium text-red-500 pt-6 pl-2" id="error_calificacion"> </label>
                            <select id="calificacion" name="calificacion" class=" w-full p-1 border-b-2 border-gray-200 bg-black/90 text-white focus:border-blue-500 focus:outline-none">
        ...
        <div class="flex items-center items-center justify-center">
            <button type="submit" onclick="agregarComentario();" class="ml-4 pl-4 pr-4 relative flex w-fit h-12 rounded-full bg-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 items-center justify-center mt-auto" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                <span class="text-xl font-semibold whitespace-nowrap dark:text-black">Agregar Comentario</span>
            </button>
        </div>
...
<script>
    ...
    function agregarComentario() {
        ...
        document.getElementById('error_calificacion').textContent = "";
        ...
        if(calificacion == "Selecciona una opción") {
            document.getElementById('error_calificacion').textContent = "❌No puedes dejar este espacio vacío.";
            error = true;
        }
